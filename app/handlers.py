...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_photo(
      ...
      caption = (
    "💳 تعليمات الدفع:\n\n"
    "🔹 يمكنك اختيار إحدى طرق الدفع التالية:\n\n"
    "1️⃣ عبر *الشام كاش*:\n"
    "   ▪️ امسح الباركود أعلاه أو أدخل باركود الشام كاش الخاص بنا التالي:\n"
    "ce95cda303cc0c382736307089e2ddeb\n\n"
    "2️⃣ عبر *سيريتل كاش* على الرقم:\n"
    "`0997625546`\n\n"
    "📌 بعد إتمام عملية الدفع، يرجى اتباع الخطوات التالية:\n"
    "▪️ الصق الرقم المنسوخ  الخاص بجهازك من داخل التطبيق.\n"
    "▪️ الصقه مباشرةً في مربع الدردشة أسفل هذه الرسالة.\n\n"
    "✍️ المثال التالي على شكل رقم الجهاز:\n"
    "`8247n312-212n-8db6-9c88-64880ec7e4b`\n\n"
    "⬇️  الصق هنا رقم جهازك المنسوخ من التطبيق داخل الدردشة التالية ⬇️"
)
...
async def text_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if "device_id" not in context.user_data:
        ...
        await update.message.reply_text("📸 أرسل الآن صورة اشعار الدفع من خلال عمل لقطة شاشة أو نص إشعار الدفع.")
        return
